    ...
    public class Rol:Entidad
    {
        ...
        public List<Funcionalidad> Funcionalidades
        {
            get
            {
                ...
                return new List<Funcionalidad> { new Funcionalidad(1, "Reservas"), new Funcionalidad(2, "Echar gente"), new Funcionalidad(5, "ABM clientes"), new Funcionalidad(6, "ABM habitaciones"), new Funcionalidad(7, "ABM de Rol") };
            }
        }
